...
DEFAULT_REMOTE_URL = (
    ...
    "main/skills/engineering-workflow/VERSION"
)
...
def main() -> int:
    ...
    print(f"Installed engineering-workflow version: {local_raw}")
    ...
    print(f"Remote engineering-workflow version: {remote_raw}")
    if local < remote:
