...
# Inspección de ramas (adaptando el nombre de la rama principal: main, master, develop)
git branch -r --merged origin/main | grep -v HEAD      # ramas remotas ya fusionadas
git branch -r --no-merged origin/main | grep -v HEAD   # ramas con trabajo sin integrar
