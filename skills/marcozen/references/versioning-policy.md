...
- `VERSION` contiene la versión SemVer instalada de `marcozen` en formato `MAJOR.MINOR.PATCH`.
- El tag Git publicado usa `marcozen-vMAJOR.MINOR.PATCH` para evitar colisiones con otras skills del repositorio.
...
Todo cambio persistente dentro de `skills/marcozen/` debe incluir en la misma Pull Request:
